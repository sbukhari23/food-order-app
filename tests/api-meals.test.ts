...
function request() { return new Request('http://localhost/api/meals', { method: 'POST', body: JSON.stringify({ name: 'New meal', description: 'Fresh', price: 12, category: 'Mains', image: 'images/new.jpg' }) }); }

describe('POST /api/meals', () => {
  beforeEach(() => { vi.clearAllMocks(); connectDb.mockResolvedValue({}); });
